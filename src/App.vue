...
<template>
  ...
  <!-- <img id="imgOne" src="./assets/img1.jpeg" alt="authors with friends">
  <p id="desc">Hello my name is Muazzam and im currently studying Web Development in Politeknik Brunei. In my free time i like to workout, play games and learn how to code. </p>
  
  <br><br><br>
  
  <HelloWorld msg="Powered Vue 3 + Vite" /> -->
  ...
  <div class="relative bg-white overflow-hidden">
        ...
        <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
          <div class="sm:text-center lg:text-left">
            <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span class="block xl:inline">Muazzam Murni</span> <br>
              {{ ' ' }}
              <span class="block text-indigo-600 xl:inline">Bahit was here</span>
            </h1>
            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Hello im Muazzam, currently studying Web Development and this is my Portfolio.</p>
            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">I am really interested in learning Web Development and in my free time i like to learn how to code.</p>
            <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">For any inquiries, contact me on my email: 20FTT1443@student.pb.edu.bn</p>
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="./assets/img1.jpeg" alt="" />
    </div>
  </div>
</template>
